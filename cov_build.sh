...
############################
# Build entservices-linearplaybackcontrol
echo "======================================================================================"
echo "buliding entservices-linearplaybackcontrol"

cd ${GITHUB_WORKSPACE}
cmake -G Ninja -S "$GITHUB_WORKSPACE" -B build/entservices-linearplaybackcontrol \
-DUSE_THUNDER_R4=ON \
...
-DDS_FOUND=ON \
-DPLUGIN_LINEARPLAYBACKCONTROL=ON \
-DHAS_FRONT_PANEL=ON \
...
cmake --build build/entservices-linearplaybackcontrol --target install
echo "======================================================================================"
exit 0
